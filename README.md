...
The public key can be stored in the repository variable. The private key content or path is only for
local builds; in CI, store the private key content in the GitHub secret.
